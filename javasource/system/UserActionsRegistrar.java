...
public class UserActionsRegistrar implements EventHandler
{
	...
	public void handleEvent(Event event)
	{
		if (event.getTopic().equals(com.mendix.core.event.EventConstants.ModelLoadedTopic()))        
		{
			...
			component.actionRegistry().registerUserAction(timeseriesconnector.actions.JA_AddChannel.class);
			component.actionRegistry().registerUserAction(timeseriesconnector.actions.JA_CountMeasurements.class);
			component.actionRegistry().registerUserAction(timeseriesconnector.actions.JA_CreateAsset.class);
			component.actionRegistry().registerUserAction(timeseriesconnector.actions.JA_DeleteAsset.class);
			component.actionRegistry().registerUserAction(timeseriesconnector.actions.JA_DeleteChannel.class);
			component.actionRegistry().registerUserAction(timeseriesconnector.actions.JA_DeleteMeasurements.class);
			component.actionRegistry().registerUserAction(timeseriesconnector.actions.JA_SearchAssetById.class);
			component.actionRegistry().registerUserAction(timeseriesconnector.actions.JA_SearchAssetsByName.class);
			component.actionRegistry().registerUserAction(timeseriesconnector.actions.JA_SearchMeasurementsBeforeDate.class);
			component.actionRegistry().registerUserAction(timeseriesconnector.actions.JA_SearchMeasurementsBetweenDates.class);
			component.actionRegistry().registerUserAction(timeseriesconnector.actions.JA_SearchMeasurementsBetweenDates_Periodic.class);
			component.actionRegistry().registerUserAction(timeseriesconnector.actions.JA_SearchMeasurementsFirst.class);
			component.actionRegistry().registerUserAction(timeseriesconnector.actions.JA_SearchMeasurementsUnique.class);
			component.actionRegistry().registerUserAction(timeseriesconnector.actions.JA_StoreMeasurement.class);
			component.actionRegistry().registerUserAction(timeseriesconnector.actions.JA_UpdateAsset.class);
		}
	}
}